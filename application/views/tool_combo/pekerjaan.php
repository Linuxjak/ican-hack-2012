...
$(document).ready(function() {
 ...
 $.ajax({
 type: "POST",
 url : "<?php echo base_url(); ?>tool_pekerjaan/hapus",
 data: info,
 success: function(){
 }
 });
...
<body>
	<div id="content">
		<h1>Pekerjaan - Sistem Manajemen Sekolah Global Mandiri</h1>
		<?php echo form_open("tool_pekerjaan/tambah"); ?>
		<input type="text" class="input-style1" style="width:250px;" name="nama" placeholder="Ketikkan nama pekerjaan..." />
