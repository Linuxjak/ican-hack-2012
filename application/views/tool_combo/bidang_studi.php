...
$(document).ready(function() {
 ...
 $.ajax({
 type: "POST",
 url : "<?php echo base_url(); ?>tool_bidang_studi/hapus",
 data: info,
 success: function(){
 }
 });
...
<body>
	<div id="content">
		<h1>Bidang Studi - Sistem Manajemen Sekolah Global Mandiri</h1>
		<?php echo form_open("tool_bidang_studi/tambah"); ?>
		<input type="text" class="input-style1" style="width:250px;" name="jabatan" placeholder="Ketikkan nama bidang studi..." />
		...
		<?php
			foreach($bidang_studi->result_array() as $a)
			{
		?>
			<tr class="record">
				<td><?php echo $a['nama_bidang_studi']; ?></td>
				<td><a class="hapus" id="<?php echo $a['id_bidang_studi']; ?>" style="cursor:pointer;">Hapus</a></td>
			</tr>
		<?php
			}
		?>
