...
$(document).ready(function() {
 ...
 $.ajax({
 type: "POST",
 url : "<?php echo base_url(); ?>tool_jabatan/hapus",
 data: info,
 success: function(){
 }
 });
...
<body>
	<div id="content">
		<h1>Jabatan Pegawai - Sistem Manajemen Sekolah Global Mandiri</h1>
		<?php echo form_open("tool_jabatan/tambah"); ?>
		<input type="text" class="input-style1" style="width:250px;" name="jabatan" placeholder="Ketikkan nama jabatan..." />
		...
		<?php
			foreach($jabatan->result_array() as $a)
			{
		?>
			<tr class="record">
				<td><?php echo $a['nama_jabatan_pegawai']; ?></td>
				<td><a class="hapus" id="<?php echo $a['id_jabatan_pegawai']; ?>" style="cursor:pointer;">Hapus</a></td>
			</tr>
		<?php
			}
		?>
