...
<div data-role="page">
   ...
   <ul data-role="listview" data-inset="true" data-theme="c" data-dividertheme="a"> 
			<li data-role="list-divider">News and Information</li>
	</ul>
	...
	foreach($berita->result_array() as $i)
	{
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr><td><h3 style="margin:0px; padding:0px;">'.$i['judul'].'</h3>
			'.tgl_indo($i['tgl_post']).' - '.$i['tgl_post'].'<br>

			</td></tr>
			<tr><td><img src="'.base_url().'asset/berita/medium/'.$i['gbr'].'" style="width:100%;"></td></tr>
			<tr><td>'.$i['isi'].'</td></tr>
		</table>
		</p>
		</div>';
